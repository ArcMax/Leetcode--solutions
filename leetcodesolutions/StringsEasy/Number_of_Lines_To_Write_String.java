 ...
 * of the line to exceed 100 units, it is written on the next line. We are given an array widths,
 * an array where widths[0] is the width of 'a', widths[1] is the width of 'b', ..., and widths[25]
 * is the width of 'z'.
 * <p>
